...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('book_contributors').insert({id: 2, book_id: 1, author_id: 4}),
    ...
    knex('book_contributors').insert({id: 6, book_id: 4, author_id: 5}),
    knex('book_contributors').insert({id: 7, book_id: 5, author_id: 5}),
    knex('book_contributors').insert({id: 8, book_id: 6, author_id: 5})
  );
};
